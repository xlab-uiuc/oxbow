 ...
 */
#define HWEIGHT8(w)                                                            \
	(BUILD_BUG_ON_ZERO(!__builtin_constant_p(w)) + __const_hweight8(w))
#define HWEIGHT16(w)                                                           \
	(BUILD_BUG_ON_ZERO(!__builtin_constant_p(w)) + __const_hweight16(w))
#define HWEIGHT32(w)                                                           \
	(BUILD_BUG_ON_ZERO(!__builtin_constant_p(w)) + __const_hweight32(w))
#define HWEIGHT64(w)                                                           \
	(BUILD_BUG_ON_ZERO(!__builtin_constant_p(w)) + __const_hweight64(w))
 ...
 */
static __always_inline void clear_bit_unlock(long nr,
 ...
 */
static __always_inline void __clear_bit_unlock(long nr,
					       volatile unsigned long *addr)
{
	barrier();
	__clear_bit(nr, addr);
 ...
 */
static __always_inline int test_and_set_bit(long nr,
					    volatile unsigned long *addr)
{
 ...
 */
static __always_inline int __test_and_set_bit(long nr,
					      volatile unsigned long *addr)
{
	int oldbit;
 ...
 * It also implies a memory barrier.
 */
static __always_inline int test_and_clear_bit(long nr,
					      volatile unsigned long *addr)
{
 ...
 */
static __always_inline int __test_and_clear_bit(long nr,
						volatile unsigned long *addr)
{
	int oldbit;
...
static __always_inline int __test_and_change_bit(long nr,
						 volatile unsigned long *addr)
{
	int oldbit;
 ...
 * It also implies a memory barrier.
 */
static __always_inline int test_and_change_bit(long nr,
					       volatile unsigned long *addr)
{
...
static __always_inline int variable_test_bit(long nr,
