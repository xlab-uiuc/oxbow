...
#define put_unaligned_le16(val, p)                                             \
	(((struct __una_u16 *)(p))->x = cpu_to_le16(val))
#define get_unaligned_le32(p) le32_to_cpu(((const struct __una_u32 *)(p))->x)
#define put_unaligned_le32(val, p)                                             \
	(((struct __una_u32 *)(p))->x = cpu_to_le32(val))
#define get_unaligned_le64(p) le64_to_cpu(((const struct __una_u64 *)(p))->x)
#define put_unaligned_le64(val, p)                                             \
	(((struct __una_u64 *)(p))->x = cpu_to_le64(val))
#endif
...
#define WRITE_ONCE(x, val)                                                     \
	({                                                                     \
		union {                                                        \
			__typeof__(x) __val;                                   \
			char __c[1];                                           \
		} __u = { .__val = (__force __typeof__(x))(val) };             \
